...
public class PrincipalJefeActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private MenuItem nav_ctas;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_tarifas) {
            fragment.beginTransaction().replace(R.id.contenedor, new TarifasFragment()).commit();
