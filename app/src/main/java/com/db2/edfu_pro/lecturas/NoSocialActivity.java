...
public class NoSocialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_no_social);

        conn = new ConexionSQLite(this,"sigees_db",null,1);

        et_valor = (EditText) findViewById(R.id.txt_energia_n);
        et_cargo = (EditText) findViewById(R.id.txt_consumidor_n);
        et_ap = (EditText) findViewById(R.id.txt_apublico_n);
        btn1 = (Button) findViewById(R.id.btn_guardar_n);
    ...
    private void registrarTarifa() {
        ...
        tarifa.setIdtipo(2);
        tarifa.setTipo_tarifa("BTS");
        tarifa.setValor_inicial(301);
        tarifa.setValor_final(999999);
        ...
        if(rs > 0){
            Toast.makeText(this,"Registro de Tarifa No Social realizado.", Toast.LENGTH_LONG).show();
            et_valor.setText("");
            et_cargo.setText("");
            et_ap.setText("");
        }else{
            Toast.makeText(this,"Registro de Tarifa No Social no realizado.", Toast.LENGTH_LONG).show();
        }
    }
}
